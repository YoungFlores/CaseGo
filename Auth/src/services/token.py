...
from schemas.token import TokenPayload, TokenPair
...
def create_token_pair(
	...
	access_token = create_token(subject=str(user_id), additional_data=additional_data)

	refresh_token = create_token(subject=str(user_id), additional_data=additional_data, token_type="refresh")
